  ...
  [4],
  {
    ...
    IKlv: function (e, t, r) {
      ...
      var k = function (e) {
        ...
        U = N.defaultLocale,
        V = D || ''
      ;(r.p = ''.concat(V, '/_next/')), _.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: B || {} })
      var W = (0, x.getURL)()
      ;(0, b.hasBasePath)(W) && (W = (0, b.delBasePath)(W))
      var K = new P.default(I, V),
        Y = function (e) {
          var t = l(e, 2),
            r = t[0],
            n = t[1]
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        s.length > 0 && void 0 !== s[0] ? s[0] : {}, (e.next = 4), K.routeLoader.whenEntrypoint('/_app')
                      )
                    case 4:
        ...
        return (
          ...
          K.loadPage('/_error').then(function (n) {
            var a = n.page,
              o = n.styleSheets,
              i = me(t),
              u = { Component: a, AppTree: i, router: z, ctx: { err: r, pathname: M, query: F, asPath: W, AppTree: i } }
            return Promise.resolve(e.props ? e.props : (0, x.loadGetInitialProps)(t, u)).then(function (t) {
              return he((0, m.default)({}, e, { err: r, Component: a, styleSheets: o, props: t }))
            })
          })
        )
      }
    ...
    bGXG: function (e, t, r) {
      ...
      t.default = function (e) {
        ;(n = e),
          o || ((o = !0), (0, a.getCLS)(i), (0, a.getFID)(i), (0, a.getFCP)(i), (0, a.getLCP)(i), (0, a.getTTFB)(i))
      }
    },
    p0hA: function (e, t, r) {
      ;(function (t) {
